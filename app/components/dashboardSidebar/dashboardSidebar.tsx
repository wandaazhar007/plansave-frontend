...
//   { title: "Expenses", icon: faWallet },
//   { title: "Incomes", icon: faMoneyBillTrendUp },
//   { title: "Analytics", icon: faChartPie },
//   { title: "Budget Planning", icon: faClipboardList },
//   { title: "Reports & History", icon: faNewspaper },
//   { title: "Notifications", icon: faBell },
//   { title: "Settings & Preferences", icon: faGear },
// ];
...
//               <button key={item.title} className={styles.navItem}>
//                 <FontAwesomeIcon icon={item.icon} className={styles.icon} />
//                 {item.title}
//               </button>
//             ))}
